                        ...
                        <div class="card form-pendaftaran">
                            <div class="card-body">
                                <div class="d-md-flex justify-content-center">
                                    <h2 class="card-title col-md-10 mb-md-0 mb-3 align-self-center text-center">Formulir Pendaftaran Ijin <br>
                                    <?php if ($jenis=='siteplan') {
                                        $jns =  'Site Plan';
                                        echo 'Site Plan';
                                    }elseif ($jenis =='krk') {
                                        $jns =  'KRK';
                                ...
                                <div class="form-wrapper">
                                        ...
                                        <input type="file" name="uploadImageFile1" id="uploadImageFile1" accept="application/pdf" onchange="showImageHereFunc1(1)"
                                    ...
                                    <div class="form-group ms-2">
                                        ...
                                        <input type="file" name="uploadImageFile2" id="uploadImageFile2" accept="application/pdf" onchange="showImageHereFunc1(2)"
                                                class="form-control ps-0 form-control-line">
                                        </div>
                                    ...
                                    <div class="form-group ms-2">
                                        ...
                                        <input type="file" name="uploadImageFile3" id="uploadImageFile3" accept="application/pdf" onchange="showImageHereFunc1(3)"
                                                class="form-control ps-0 form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group ms-2">
                                        ...
                                        <input type="file" name="uploadImageFile4" id="uploadImageFile4" accept="application/pdf" onchange="showImageHereFunc1(4)"
                                                class="form-control ps-0 form-control-line">
                                        </div>
                                    </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-8">
                                                <label for="example-email" class="col-md-12">Alamat Pemohon (Nama Jalan/Dusun/Dukuh)<sup style="color:red;font-size:14px">*</sup></label>
                                    ...
                                    <div class="form-wrapper">
										...
										<div class="form-group ms-2" id='divkel1'>
									...
									<div class="form-wrapper" id='divkec1' style="display:none">
                                        <div class="form-group">
											<label class="col-sm-12">Masukkan Nama Kecamatan<sup style="color:red;font-size:14px">*</sup></label>
											<div class="col-sm-12 border-bottom">
												<input type="text" id="kecamatan_man1" name="kecamatan_man1" class="form-control ps-0 form-control-line">
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-12">Masukkan Nama Kelurahan<sup style="color:red;font-size:14px">*</sup></label>
											<div class="col-sm-12 border-bottom">
												<input type="text" id="kelurahan_man1" name="kelurahan_man1" class="form-control ps-0 form-control-line">
											</div>
										</div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="number"  name="no_hp"  id="no_hp" placeholder="isi dengan nomor yang bisa dihubungi"
                                                class="form-control ps-0 form-control-line">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-8">
                                                <label for="example-email" class="col-md-12">Alamat Lokasi  (Nama Jalan/Dusun/Dukuh)<sup style="color:red;font-size:14px">*</sup></label>
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <input type="text" name="rt_lokasi" id="rt_lokasi" placeholder="RT"
                                                class="form-control ps-0 form-control-line">
                                            </div>
                                            <div class="col-md-2">
                                                <label for="example-email" class="col-md-12">RW</label>
                                                <input type="text" name="rw_lokasi" id="rw_lokasi" placeholder="RW"
                                                class="form-control ps-0 form-control-line">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group ms-2" id="divkel2" >
                                        <label class="col-sm-12">Kelurahan<sup style="color:red;font-size:14px">*</sup></label>
                                        <div class="col-sm-12 border-bottom">
                                    ...
                                    <div class="form-wrapper" id="divkec2" style="display:none">
                                        <div class="form-group">
                                        <label class="col-sm-12">Masukkan Nama Kecamatan<sup style="color:red;font-size:14px">*</sup></label>
                                        <div class="col-sm-12 border-bottom">
                                            <input type="text" id="kecamatan_man2" name="kecamatan_man2" class="form-control ps-0 form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-12">Masukkan Nama Kelurahan<sup style="color:red;font-size:14px">*</sup></label>
                                        <div class="col-sm-12 border-bottom">
                                           <input type="text" id="kelurahan_man2" name="kelurahan_man2" class="form-control ps-0 form-control-line">
                                        </div>
                                    </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <input type="hidden" name="jns" id="jns" value="<?=$jenis?>"
                                            class="form-control ps-0 form-control-line">
                                        <input type="text" name="rencana" id="rencana" value=""
                                            class="form-control ps-0 form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-12 d-flex">
                                            <button onclick="validasi()" class="btn btn-primary mx-auto mx-md-0 text-white">Simpan</button>
                                        </div>
                                    </div>
...
function showImageHereFunc1(e) {
    ...
    for(var i=0;i<total_file;i++) {
        ...
        $('#foto'+e).html("<div style='width:130x;border: 2px solid black;border-radius: 10px;padding-top:3px;padding-left:3px;padding-right:3px;padding-bottom:3px'><img  style='border-radius: 10px;' src='<?=base_url("assets/images/pdf.png")?>' width='100px' ></div>");
    }
};
window.onload = function() {
   ...
   function kel(a) {
	   if (a!=5) {
		     document.getElementById('divkec1').style.display = 'none';
		   document.getElementById('divkel1').style.display = 'block';
       $.ajax({
               type: 'POST',
		   ...
		   document.getElementById('divkec1').style.display = 'block';
		   document.getElementById('divkel1').style.display = 'none';
	   }
   }
   function kel_lokasi(a) {
	   if (a!=5) {
		     document.getElementById('divkec2').style.display = 'none';
		   document.getElementById('divkel2').style.display = 'block';
       $.ajax({
               type: 'POST',
                 url: "<?=base_url('Pendaftaran/kelurahan/')?>"+a,
                 success: function(msg){
		      ...
		      document.getElementById('divkec2').style.display = 'block';
		   document.getElementById('divkel2').style.display = 'none';
	   }
   }
   function validasi() {
       const foto1 = $('#uploadImageFile1').prop('files')[0];
      ...
      if (fot1 == '') {
            swal('Terjadi Kesalahan','Foto KTP Tidak Boleh Kosong')
            return;
        }
        if (fot2 == '') {
            swal('Terjadi Kesalahan','Foto SERTIFIKAT Tidak Boleh Kosong')
            return;
        }
       var nama = document.getElementById('nama').value;
       var alamat = document.getElementById('alamat').value;
	   var kecamatan_man1 = document.getElementById('kecamatan_man1').value;
       var kelurahan_man1 = document.getElementById('kelurahan_man1').value;
	  
	   var kecamatan_man2 = document.getElementById('kecamatan_man2').value;
       var kelurahan_man2 = document.getElementById('kelurahan_man2').value;
       ...
       if (geo == ""){
			...
			swal('Terjadi Kesalahan','Anda Belum Rencana Pemanfaatan Ruang'); 
            return;
       }else{ 
		...
		formData.append('kecamatan_man1',kecamatan_man1);
        formData.append('kelurahan_man1',kelurahan_man1);
		formData.append('kecamatan_man2',kecamatan_man2);
        formData.append('kelurahan_man2',kelurahan_man2);			
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url('Pendaftaran/tambah'); ?>',
		    data: formData,
		    cache: false,
		    processData: false,
		    contentType: false,
            success: function(response)
            {
               if (response == 'Data Sukses') {
                ...
                swal('Gagal','Permohonan Gagal Dikirim');
                return;
               }
  ...
  function buka(){
    ...
    h = h + '<video id="myVideo" width="100%" style="border-radius:15px" controls><source src="http://125.166.239.48/simantan/assets/tutorial/gambar.mp4" type="video/mp4">';
    ...
    h = h + '<div id="result" value="" style="display: none;"></div><input type="hidden" placeholder="" name="geo" id="geo">';
    $('#mymap_nya').html(h);
    peta();
  }
   ...
   function tutup(){
    $('#mymap_nya').html('<h4 class="card-title text-center">Gambar Lokasi Permohonan</h4><div id="map" class="card form-pendaftaran" style="width: 100%; height: 500px;"></div><div id="result" value="" style="display: none;"></div><input type="hidden" placeholder="" name="geo" id="geo"><button onClick="buka()">Lihat Panduan</button>');
    peta()
   }
