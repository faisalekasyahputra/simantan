...
<meta charset="utf-8">
		...
		<link href="<?=base_url('assets/css/bootstrap.min_admin.css')?>" rel="stylesheet" type="text/css" />
		<link href="<?=base_url('assets/css/switchery.min.css')?>" rel="stylesheet" />
		<!-- Font Awesome CSS -->
		<link href="<?=base_url('assets/css/font-awesome.min.css')?>" rel="stylesheet" type="text/css" />
		
		<!-- Custom CSS -->
		<link href="<?=base_url('assets/css/style_admin.css')?>" rel="stylesheet" type="text/css" />
		...
		<link href="<?=base_url('assets/css/jquery.filer-dragdropbox-theme.css')?>" rel="stylesheet" />
