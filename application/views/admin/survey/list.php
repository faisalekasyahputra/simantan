<div class="content-page">
                    ...
                    <?php if ($data !=null) {
                       ...
                       ?>
                        ...
                        <tr>
                          ...
                          <a role="button" href="<?=base_url('Spatial/detail_survey/'.$d->id)?>" class="btn btn-primary"><span class="btn-label"><i class="fa fa-info"></i></span>Detail</a>
    ...
    <script>
      function hapus(id) {
        ...
        if (dialog) {
          location.href="<?php echo base_url().'Spatial/delete_survey/'?>"+id;
        }else{
          return;
        }
      }
