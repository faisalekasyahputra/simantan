...
<nav class="navbar nav-first navbar-expand-lg">
            ...
            <div class="row ">
                    <div class="col d-flex" style="align-content: center; align-items: center;">
                        ...
                        <div class="col ps-2">
                            <p class="fw-bold m-0 p-0 text-white" id="gagal">SIMANTAN</p>
                            <p class="text-center fw-light p-0 m-0 text-white" style="font-size:7px ;" id="gagal">Sistem Informasi Pelayanan Tata Ruang Kota Pekalongan</p>
                        </div>
              ...
              <div class="collapse navbar-collapse" id="navbarScroll">
                <ul class="navbar-nav nav-pills ms-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 200px;">
                  <li class="nav-item">
                        <a class="nav-link mx-2 menu" aria-current="page" href="<?=base_url('KRK/landing')?>">Home</a>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a class="nav-link mx-2 menu " href="<?=base_url('KRK/landing')?>">Pendaftaran KRK</a>
                  </li>
				   <li class="nav-item">
...
var attr= L.control({
    ...
    attr.onAdd = function(map) {
        ...
        this.update('<h6><b>Informasi Peta</b></h6>','<center>"Silkahkan arahkan cursor mouse anda atau dengan mengklik layer peta untuk melihat informasi peta"</center>');
        return this._div;
    }
        ...
        poly2.features.forEach(function(layer2){
            ...
            if(intersection!=undefined){
                ...
                interLayer.eachLayer(function (l1) {
                    ...
                    if (jum <=10) {
                    if (seeArea > 0){
                        con = con + "<tr><td>"+kode+"</td><td>"+seeArea+" m <sup>2</sup></td></tr>"
                    }
                }
                 jum = jum + 1; 
                });
